...
<div class="imerss-content-frame">
 <div class="imerss-image-header">
  <div class="imerss-image-holder imerss-column-left" data-toggle="tooltip" style="background-image: url(../img/Liverworts/Cephaloziellaceae/Cephaloziella_divaricata/macro_pics/Cephaloziella_divaricata_JR_01.jpg)" title="John Reynolds">
  </div>

  <div class="imerss-image-holder imerss-column-right" data-toggle="tooltip" style="background-image: url(../img/Liverworts/Cephaloziellaceae/Cephaloziella_divaricata/macro_pics/Cephaloziella_divaricata_CW_01.png)" title="Connor Wardrop">
  </div>
...
<div class="imerss-image-holder imerss-column-right" data-toggle="tooltip" style="background-image: url(../img/)" title="XXXXX">
</div>
...
<div class="modal micromodal-slide" id="modal-plate" aria-hidden="true">
 <div class="modal__overlay" tabindex="-1" data-micromodal-close>
  ...
  <div class="modal__content" id="modal-plate-content">
   <div class="imerss-image-holder" data-toggle="tooltip" style="background-image: url(../img/Liverworts/Cephaloziellaceae/Cephaloziella_divaricata/plates/Cephaloziella_divaricata_RM_01_plate.jpg)" title="Randal Mindell">
  </div>
  </div>
  </div>
 </div>
